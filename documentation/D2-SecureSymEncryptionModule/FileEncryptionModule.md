...
Para la implementación de AES-GCM se utiliza un tamaño de llave 256 bits, el cual es el tamaño máximo aceptado en en el estándar, para la derivación de la llave maestra a partir de la contraseña de usuario se utilizo un algoritmo de hash SHA256 con una llave de 256 bits, estos tamaños se alinean con las recomendaciones del NIST para el cifrado simétrico.
